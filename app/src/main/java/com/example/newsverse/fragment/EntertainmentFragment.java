...
import com.example.newsverse.api.BusinessApiInterface;
...
public class EntertainmentFragment extends BaseArticleFragment {
    public void LoadJson(final String keyword) {
        ...
        EntertainmentApiInterface apiInterface = ApiClient.getApiClient().create(EntertainmentApiInterface.class);
