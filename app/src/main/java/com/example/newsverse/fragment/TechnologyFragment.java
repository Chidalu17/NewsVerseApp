...
import com.example.newsverse.api.TechnologyApiInterface;
...
public class TechnologyFragment extends BaseArticleFragment {
    public void LoadJson(final String keyword) {
        ...
        TechnologyApiInterface apiInterface = ApiClient.getApiClient().create(TechnologyApiInterface.class);
