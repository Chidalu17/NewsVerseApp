...
import com.example.newsverse.api.SportsApiInterface;
...
public class SportsFragment extends BaseArticleFragment {
    public void LoadJson(final String keyword) {
        ...
        SportsApiInterface apiInterface = ApiClient.getApiClient().create(SportsApiInterface.class);
