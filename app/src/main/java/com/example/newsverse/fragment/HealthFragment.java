...
import com.example.newsverse.api.HealthApiInterface;
...
public class HealthFragment extends BaseArticleFragment {
    public void LoadJson(final String keyword) {
        ...
        HealthApiInterface apiInterface = ApiClient.getApiClient().create(HealthApiInterface.class);
